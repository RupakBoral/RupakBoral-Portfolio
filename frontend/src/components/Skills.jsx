...
const Skills = () => {
    ...
    return (
        <div className='space-y-6'>
            <h1 className='text-4xl font-semibold text-zinc-200 md:text-left text-center reveal-down'>Skills</h1>
            <p className='md:w-1/2 w-auto text-zinc-300 md:text-left text-center reveal-down'>Discover the powerful tools and technologies I use to create exceptional websites and applications.</p>
