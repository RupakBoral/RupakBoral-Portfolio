...
const Hero = () => {
    return (
        <div id='home' className='flex font-sans pt-[20%] -space-x-8 md:space-x-0 overflow-x-hidden '>
            <div className='flex flex-col gap-8 justify-center'>
                <div className='flex items-center gap-4'>
                    <img src={developer} className='w-12 h-12 rounded-full reveal-up' alt=''/>
                    <p className='text-zinc-400 text-base reveal-down'>Available for work</p>
                </div>
                <h1 className='text-5xl w-3/4 font-semibold text-zinc-100 reveal-up'>Building Scalable Modern Website for the Future</h1>
                <div className='flex justify-between w-3/4 gap-4 reveal-down'>
                    <a href='https://drive.google.com/file/d/1bNSLU7efOcQ9wTXfVhjvQ16NbgvC26_k/view?usp=drive_link' target='blank'>
                    ...
                    <a href='#about'>
                        <button className='flex gap-4 p-3 bg-gray-800 text-sky-500 rounded-xl font-medium text-sans'> 
                            <p>Scroll Down </p>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5084C1"><path d="M440-800v487L216-537l-56 57 320 320 320-320-56-57-224 224v-487h-80Z"/></svg>
                        </button>
                    </a>
                </div>
            </div>
