...
const PortfolioHighlights = () => {
  ...
  return (
      <div id='work' className='reveal-up flex flex-col space-y-10'>
          <p className='text-4xl font-semibold text-zinc-200 md:text-left text-center'>My Portfolio Highlights</p>
